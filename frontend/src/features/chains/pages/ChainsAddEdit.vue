...
import { ref } from 'vue'
import { CalendarIcon, ChevronDownIcon, PlusIcon, XIcon } from '@lucide/vue'
...
<template>
  ...
  <div class="grid grid-cols-2 gap-6">
    ...
    <div class="space-y-6">
      <!-- Icon & Color -->
      <div class="bg-white rounded-3xl border border-gray-100 p-6 shadow-sm">
        <h2 class="text-xl font-bold text-gray-900 mb-2">Icon & Color</h2>
        ...
        <div class="flex gap-3">
          <button
            ...
            :class="[
              ...
              color,
              selectedColor === color ? 'ring-gray-300' : 'ring-transparent',
            ]"
      ...
      <!-- Milestones -->
      <div class="bg-white rounded-3xl border border-gray-100 p-6 shadow-sm">
        <h2 class="text-xl font-bold text-gray-900 mb-2">Milestone Settings</h2>
  ...
  <div class="mt-6 flex justify-end gap-4">
    <button
      class="px-6 py-3 rounded-2xl border border-gray-200 bg-white font-medium text-gray-700 hover:bg-gray-50 transition"
    >
      Cancel
    </button>
