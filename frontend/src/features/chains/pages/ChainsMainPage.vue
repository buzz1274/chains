...
<template>
  ...
  <NoResults v-if="chainsStore.chains.length === 0">
    <template #no-content-message>
    ...
    <div class="grid grid-cols-3 gap-4">
      ...
      <div class="bg-white rounded-2xl border border-gray-100 p-5 shadow-sm">
          ...
          <div class="relative w-20 h-20 flex-shrink-0">
            <svg class="w-20 h-20 -rotate-90" viewBox="0 0 80 80">
              ...
              <circle
                ...
                :stroke-dashoffset="`${2 * Math.PI * 34 * (1 - streakProgress)}`"
        ...
        <div class="bg-green-50 rounded-xl px-4 py-2.5 text-sm text-gray-600">
          You have
          <span class="text-green-600 font-bold">{{ timeLeft }}</span> left today
        </div>
      </div>
